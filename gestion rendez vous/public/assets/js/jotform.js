...
//                        p.$jot('.jt-content, .jt-title').css('width', 'auto');
     ...
     */
    editMode: function (data, noreset, skipField, skipCardIndex, cb) {
        if (cb === undefined) {
            cb = function() { };
        }
  ...
  /**
    ...
    track: function (w, d) {
        ...
        function createImageEl(uuid) {
            var visibleFormFooter = '';

            var viewBrandingFooter = document.querySelector('.formFooter') !== null;
            var viewEarthquakeFooter = document.querySelector('.earthquake-donation') !== null;

            if (viewEarthquakeFooter) {
                visibleFormFooter = '_eqf';
            } else if (viewBrandingFooter) {
                visibleFormFooter = '_bf';
            }
            ...
            if (uuid) {
                src = src + '&eventID=' + encodeURIComponent(uuid + visibleFormFooter);
            }
